 ...
 * @author Rama
 */
public class usuarioBuscar extends javax.swing.JPanel {
    ...
    private void listarClientes() {
        List<Usuarios> lista = cu.listar();
        Usuario = (DefaultTableModel) Tabla.getModel();
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[4] = lista.get(i).getCedula();
            ob[5] = lista.get(i).getTelefono();
            ob[6] = lista.get(i).getTipoUsuario();
            Usuario.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        añadirTxt.setText(" Añadir Usuario");
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Usuario", "Nombre", "Apellido", "Cedula", "Telefono", "Rol"
            }
        ));
        ...
        ButtonEliminarLayout.setHorizontalGroup(
            ...
            .addComponent(eliminarTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
        );
        ...
        icon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/usuariosMini.png"))); // NOI18N
    ...
    private void añadirTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_añadirTxtMousePressed
        usuarioRegistrar ur = new usuarioRegistrar();
        ur.setSize(700, 450);
        ur.setLocation(0, 0);

        Contenedor.removeAll();
        Contenedor.add(ur, BorderLayout.CENTER);
    ...
    private void eliminarTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eliminarTxtMousePressed
        if (!CampoInvisible.getText().isEmpty()) {
            int confirmacion = JOptionPane.showConfirmDialog(null, "¿Estas seguro de eliminar a este cliente?", "Confirmar", 2);
            if (confirmacion == 0) {
                int fila = Tabla.getSelectedRow();
                CampoInvisible.setText(Tabla.getValueAt(fila, 0).toString());
                if (!CampoInvisible.getText().equals("1")) {
                    u.setIdUsuario(Integer.parseInt(CampoInvisible.getText()));
                    cu.eliminar(u);
                    CampoInvisible.setText("");
                    limpiarTabla();
                    listarClientes();
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR: No se puede eliminar al  'Administrador principal'. PROCESO ABORTADO");
                }
            }
        } else {
    ...
    void limpiarTabla() {
        for (int i = 0; i < Usuario.getRowCount(); i++) {
            Usuario.removeRow(i);
            i = 0 - 1;
        }
    }
    ...
    void filtrar() {
        TableRowSorter sorter = new TableRowSorter(Usuario);
