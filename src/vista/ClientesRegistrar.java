 ...
 * @author Rama
 */
public class ClientesRegistrar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        RegistroTitulo.setText("Registro de Clientes");
    ...
    private void TxtRegistrarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtRegistrarMousePressed
        ...
        if (!nombreTxt.getText().isEmpty() && !apellidoTxt.getText().isEmpty() && !cedulaTxt.getText().isEmpty()) {
            ...
            if (!cc.duplicados(cedulaTxt.getText().trim())) {
