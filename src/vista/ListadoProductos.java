...
public class ListadoProductos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        CategoriasAñadir = new vista.JpanelRound();
        ...
        Subtitulo.setText("Productos");

        CategoriasAñadir.setBackground(new java.awt.Color(255, 204, 153));
        CategoriasAñadir.setRoundBottomLeft(10);
        CategoriasAñadir.setRoundBottomRight(10);
        CategoriasAñadir.setRoundTopLeft(10);
        CategoriasAñadir.setRoundTopRight(10);

        categoriasTxt.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        ...
        categoriasTxt.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Categorias.png"))); // NOI18N
        categoriasTxt.setText("Categorias");
        categoriasTxt.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        categoriasTxt.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                categoriasTxtMousePressed(evt);
            }
        });

        javax.swing.GroupLayout CategoriasAñadirLayout = new javax.swing.GroupLayout(CategoriasAñadir);
        CategoriasAñadir.setLayout(CategoriasAñadirLayout);
        CategoriasAñadirLayout.setHorizontalGroup(
            CategoriasAñadirLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(categoriasTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
        );
        CategoriasAñadirLayout.setVerticalGroup(
            CategoriasAñadirLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, CategoriasAñadirLayout.createSequentialGroup()
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/productos.png"))); // NOI18N
        ...
        añadirTxt.setText(" Añadir Producto");
        ...
        ButtonAñadirLayout.setVerticalGroup(
            ButtonAñadirLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ButtonAñadirLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(añadirTxt))
        );
        ...
        ContenedorLayout.setHorizontalGroup(
            ...
            .addGroup(ContenedorLayout.createSequentialGroup()
                ...
                .addGroup(ContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Titulo))
                .addGap(155, 155, 155)
                .addComponent(CategoriasAñadir, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void categoriasTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriasTxtMousePressed
        Categorias2 ct2 = new Categorias2();
        ct2.setSize(700, 450);
        ct2.setLocation(0, 0);

        Contenedor.removeAll();
        Contenedor.add(ct2, BorderLayout.CENTER);
        Contenedor.revalidate();
        Contenedor.repaint();
    }//GEN-LAST:event_categoriasTxtMousePressed

    private void categoriasTxtMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriasTxtMouseEntered
        CategoriasAñadir.setBackground(new Color(255, 204, 102));
    ...
    private void categoriasTxtMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriasTxtMouseExited
        CategoriasAñadir.setBackground(new Color(255, 204, 153));
    ...
    private void editarTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editarTxtMousePressed
        if (!CampoInvisible.getText().isEmpty()) {
            ...
            pe.ObtenerDato(Tabla.getValueAt(fila, 0).toString(), Tabla.getValueAt(fila, 1).toString(), Tabla.getValueAt(fila, 2).toString(), Tabla.getValueAt(fila, 3).toString(), Tabla.getValueAt(fila, 4).toString(), Tabla.getValueAt(fila, 5).toString(), Tabla.getValueAt(fila, 6).toString(), Tabla.getValueAt(fila, 7).toString());
    ...
    private vista.JpanelRound CategoriasAñadir;
