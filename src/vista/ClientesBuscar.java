 ...
 * @author Rama
 */
public class ClientesBuscar extends javax.swing.JPanel {
    ...
    private void listarClientes() {
        List<Clientes> lista = cc.listar();
        Clientes = (DefaultTableModel) Tabla.getModel();
    ...
    private void initComponents() {
        ...
        añadirTxt.setText(" Añadir Cliente");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/clientesMini.png"))); // NOI18N
    ...
    private void añadirTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_añadirTxtMousePressed
        ClientesRegistrar cb = new ClientesRegistrar();
        cb.setSize(700, 450);
        cb.setLocation(0, 0);
    ...
    private void editarTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editarTxtMousePressed
        if (!CampoInvisible.getText().isEmpty()) {
            ...
            ce.ObtenerDato(Tabla.getValueAt(fila, 0).toString(), Tabla.getValueAt(fila, 1).toString(), Tabla.getValueAt(fila, 2).toString(), Tabla.getValueAt(fila, 3).toString(), Tabla.getValueAt(fila, 4).toString(), Tabla.getValueAt(fila, 5).toString(), Tabla.getValueAt(fila, 6).toString());
            ce.ContadorTexto.setText(ce.contador() + "");
            ce.setSize(700, 450);
            ce.setLocation(0, 0);

            Contenedor.removeAll();
            Contenedor.add(ce, BorderLayout.CENTER);
            Contenedor.revalidate();
            Contenedor.repaint();
        } else {
            JOptionPane.showMessageDialog(null, "Seleccione un cliente", "Advertencia", 1);
    ...
    void filtrar() {
        TableRowSorter sorter = new TableRowSorter(Clientes);
