 ...
 * @author Rama
 */
public class ProductosAñadir extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ButtonAgregar = new vista.JpanelRound();
        ...
        RegistroTitulo.setText("Registro de Producto");

        ButtonAgregar.setBackground(new java.awt.Color(156, 211, 216));
        ButtonAgregar.setPreferredSize(new java.awt.Dimension(100, 50));
        ButtonAgregar.setRoundBottomLeft(10);
        ButtonAgregar.setRoundBottomRight(10);
        ButtonAgregar.setRoundTopLeft(10);
        ButtonAgregar.setRoundTopRight(10);

        TxtAgregar.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        ...
        TxtAgregar.setPreferredSize(new java.awt.Dimension(100, 50));
        TxtAgregar.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                TxtAgregarMousePressed(evt);
            }
        });

        javax.swing.GroupLayout ButtonAgregarLayout = new javax.swing.GroupLayout(ButtonAgregar);
        ButtonAgregar.setLayout(ButtonAgregarLayout);
        ButtonAgregarLayout.setHorizontalGroup(
            ButtonAgregarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ButtonAgregarLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(TxtAgregar, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ButtonAgregarLayout.setVerticalGroup(
            ButtonAgregarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ButtonAgregarLayout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(TxtAgregar, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        ContenedorLayout.setVerticalGroup(
            ...
            .addGroup(ContenedorLayout.createSequentialGroup()
                ...
                .addGroup(ContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(ButtonAgregar, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
    ...
    private void TxtAgregarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtAgregarMousePressed
        //Getter and setters
        ...
        if (!nombreDPTxt.getText().isEmpty() && !CodigoTxt.getText().isEmpty() && !precioTxt.getText().isEmpty() && !cantidadTxt.getText().isEmpty() && !descripcionTxt.getText().isEmpty()) {
            ...
            if (!cp.duplicados(CodigoTxt.getText().trim())) {
                ...
                if (iva.equalsIgnoreCase("Seleccione Iva:")) {
                    ...
                    if (categoria.equalsIgnoreCase("Seleccione Categoria:")) {
                        ...
                        try {
                            ...
                            i.setCodigo(CodigoTxt.getText());
                            i.setProducto(nombreDPTxt.getText());
                            i.setSustraccion(0);
                            i.setFecha(Fecha);
                            i.setProveedor("Producto Nuevo");
                            i.setAdicion(Integer.parseInt(cantidadTxt.getText()));
                            ci.insertar(i);

                                //Finaliza el codigo
                                this.CargarComboCategorias();
                                this.ivaComboBox.setSelectedItem("Seleccione Iva:");
                                this.limpiarCampos();
    ...
    private void TxtAgregarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TxtAgregarMouseEntered
        ButtonAgregar.setBackground(new Color(3, 150, 166));
    ...
    private void nombreDPTxtKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombreDPTxtKeyTyped
        char ch = evt.getKeyChar();
        if (nombreDPTxt.getText().length() >= 100 || (!Character.isLetterOrDigit(ch) && ch != ' ')) {
            evt.consume();
        }
    ...
    private vista.JpanelRound ButtonAgregar;
